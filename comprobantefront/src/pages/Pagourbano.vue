...
export default {
  ...
  methods:{
      ...
      this.$q.dialog({
        ...
        this.$axios.put(process.env.URL+'/comprobante/'+this.micomprobante.id,{nrocomprobante:this.nrocomprobante}).then(
          async res=>{
            ...
            // doc.text(x+15.6, y+10.7, 'CODIGO CATASTRAL');
    ...
    reportesinitem(dat){
      ...
      dat.detalles.forEach(r=>{
        ...
        if(r.detalle.toString().length<55){
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(0,55));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(55,110));
          // while (r.detalle.toString().length>=cont){
          //   console.log(r.detalle.toString())
          //   doc.text(xx+2.5, yy, r.detalle.toString().substring(cont,fin));
          //   cont+=55;
          //   fin+=55
          //   yy+=0.3;
          // }
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(55,110));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(110,165));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(110,165));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(165,220));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(165,220));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(220,275));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(220,275));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(275,330));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(275,330));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(330,385));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(330,385));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(385,440));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(385,440));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(440,495));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(440,495));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(495,550));
          ...
          doc.text(xx+2.5, yy, r.detalle.toString().substring(495,550));
          yy+=0.3
          doc.text(xx+2.5, yy, r.detalle.toString().substring(550,605));
    ...
    reimprimirsinitem(comprobante){
      this.$q.loading.show()
      this.$axios.post(process.env.URL+'/imprimir',{id:comprobante.id}).then(res=>{
        this.$q.loading.hide()
        let dat=res.data[0]
        this.reportesinitem(dat)
      })
    },
    frmimprimir(i){
