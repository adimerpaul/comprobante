...
class MercadoController extends Controller
{
    ...
    {
        return ("SELECT fecha,COUNT(*) as num,SUM(total) as total FROM comprobantes WHERE nrocomrporbante!='' AND  unid_id='".$request->user()->unid_id."' fecha >= '".$request->fecha1."' AND fecha <= '".$request->fecha2."' GROUP BY fecha");
    }
